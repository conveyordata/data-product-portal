...
from app.configuration.data_product_types.model import (
    DataProductType as DataProductTypeModel,
)
from app.configuration.data_product_types.model import (
    ensure_data_product_type_exists,
)
...
class DataProductTypeService:
    ...
    def get_data_product_types(self) -> Sequence[DataProductTypesGetItem]:
        return (
            self.db.scalars(
