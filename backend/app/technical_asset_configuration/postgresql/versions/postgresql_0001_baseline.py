"""Baseline for the PostgreSQL technical asset configuration table.

The table already exists in every deployment that ran the core migrations
from before PostgreSQL became a plugin, so this revision creates it only when
it is missing. From here on the table belongs to this plugin's own migration
history.

Revision ID: postgresql_0001_baseline
Revises:
"""
...
revision: str = "postgresql_0001_baseline"
down_revision: Union[str, None] = None
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

TABLE = "postgresql_technical_asset_configurations"
