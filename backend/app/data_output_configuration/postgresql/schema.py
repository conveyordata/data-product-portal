...
from app.data_output_configuration.postgresql.model import (
    PostgresTechnicalAssetConfiguration as PostgresTechnicalAssetConfigurationModel,
)
from app.data_products.schema import DataProduct


class PostgresTechnicalAssetConfiguration(AssetProviderPlugin):
    ...
    class Meta:
        orm_model = PostgresTechnicalAssetConfigurationModel
    ...
    def get_configuration(
        self, configs: list[PostgresConfig]
