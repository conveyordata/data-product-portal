...
class EventType(str, Enum):
    ...
    DATA_PRODUCT_SETTING_UPDATED = "data_product_setting_updated"
    ...
    DATA_PRODUCT_DATASET_LINK_RENEWED = "data_product_dataset_link_renewed"

    DATASET_CREATED = "dataset_created"
    DATASET_UPDATED = "dataset_updated"
    DATASET_REMOVED = "dataset_removed"
    DATASET_SETTING_UPDATED = "dataset_setting_updated"
