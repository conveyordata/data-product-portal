...
from app.data_products.output_ports.links.schema_request import (
...
router = APIRouter(tags=["Data Products - Output ports - Links"])
old_route = "/data_product_dataset_links"
route = "/v2/data_products/{data_product_id}/output_ports/{output_port_id}/links"
