...
DATA_OUTPUTS_DATASETS_ENDPOINT = "api/v2/data_products/{}/technical_assets"
...
class TestDataOutputsDatasetsRouter:
    ...
    def approve_link_between_technical_asset_and_output_port(
        ...
        return client.post(
            f"{DATA_OUTPUTS_DATASETS_ENDPOINT.format(data_product_id)}/{technical_asset_id}/approve_output_port_link",
            json={"output_port_id": f"{output_port_id}"},
        )
    ...
    def deny_link_between_technical_asset_and_output_port(
        ...
        return client.post(
            f"{DATA_OUTPUTS_DATASETS_ENDPOINT.format(data_product_id)}/{technical_asset_id}/deny_output_port_link",
            json={"output_port_id": f"{output_port_id}"},
        )
