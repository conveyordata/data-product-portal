...
begin
    ...
    -- ENVIRONMENTS
    INSERT INTO public.environments ("name", context, acronym, is_default, created_on, updated_on, deleted_at) VALUES ('development', 'arn:aws:iam::123456789123:role/{{}}-dev-demo', 'dev', true, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id INTO returned_environment_id_dev;
    INSERT INTO public.environments ("name", context, acronym, is_default, created_on, updated_on, deleted_at) VALUES ('production', 'arn:aws:iam::123456789123:role/{{}}-prd-demo', 'prd', false, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id INTO returned_environment_id_prd;

    INSERT INTO public.env_platform_configs (id, environment_id, platform_id, "config", created_on, updated_on, deleted_at) VALUES ('daa8e3e8-1485-4eb2-8b4b-575e8d10a570', returned_environment_id_dev, returned_platform_id, '{"account_id": "123456789123", "region": "eu-west-1", "can_read_from": ["production"]}', timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL);
    INSERT INTO public.env_platform_configs (id, environment_id, platform_id, "config", created_on, updated_on, deleted_at) VALUES ('e2aa2f6d-585f-4b43-8ea4-982b7bab0142', returned_environment_id_prd, returned_platform_id, '{"account_id": "123456789123", "region": "eu-west-1", "can_read_from": []}', timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL);
    INSERT INTO public.env_platform_service_configs (id, environment_id, platform_id, service_id, "config", created_on, updated_on, deleted_at) VALUES('93f4b677-5ae8-450d-91a6-e15196b2e774', returned_environment_id_dev, returned_platform_id, s3_service_id, '[{"identifier":"datalake","bucket_name":"datalake-bucket-dev","bucket_arn":"arn:aws:s3:::datalake-bucket-dev","kms_key_arn":"arn:aws:kms:eu-west-1:123456789123:key/<random_guid>","is_default":true},{"identifier":"ingress","bucket_name":"datalake-bucket-dev","bucket_arn":"arn:aws:s3:::datalake-bucket-dev","kms_key_arn":"arn:aws:kms:eu-west-1:123456789123:key/<random_guid>","is_default":false},{"identifier":"egress","bucket_name":"datalake-bucket-dev","bucket_arn":"arn:aws:s3:::datalake-bucket-dev","kms_key_arn":"arn:aws:kms:eu-west-1:123456789123:key/<random_guid>","is_default":false}]', timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL);
    INSERT INTO public.env_platform_service_configs (id, environment_id, platform_id, service_id, "config", created_on, updated_on, deleted_at) VALUES('9c1d025c-f342-4665-8461-ba8b9f4035ff', returned_environment_id_prd, returned_platform_id, s3_service_id, '[{"identifier":"datalake","bucket_name":"datalake-bucket-prd","bucket_arn":"arn:aws:s3:::datalake-bucket-prd,"kms_key_arn":"arn:aws:kms:eu-west-1:123456789123:key/<random_guid>","is_default":true},{"identifier":"ingress","bucket_name":"datalake-bucket-prd","bucket_arn":"arn:aws:s3:::datalake-bucket-prd,"kms_key_arn":"arn:aws:kms:eu-west-1:123456789123:key/<random_guid>","is_default":false},{"identifier":"egress","bucket_name":"datalake-bucket-prd","bucket_arn":"arn:aws:s3:::datalake-bucket-prd,"kms_key_arn":"arn:aws:kms:eu-west-1:123456789123:key/<random_guid>","is_default":false}]', timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL);
    ...
    INSERT INTO public.users (email, id, external_id, first_name, last_name, created_on, updated_on, deleted_at) VALUES ('john.doe@dataminded.com', 'b72fca38-17ff-4259-a075-5aaa5973343c', 'john.scientist@pharma.com', 'John', 'Scientist', timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id INTO john_id;
