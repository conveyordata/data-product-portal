...
begin
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES (gen_random_uuid(), 'Customer Segmentation', 'customer_segmentation', 'data_products', 'Groups customers based on demographics, behavior, and purchase patterns.', customer_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into customer_segmentation_id;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (customer_segmentation_id, '<h2>Customer Segmentation</h2><p></p><p>This data product aims to provide a centralized view of customer segments across demographics and behavior.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Enable targeted marketing and product strategies</li><li>Identify high-value customer groups</li><li>Support personalized engagement campaigns</li></ul>', 'ACTIVE', '3c289333-2d55-4aed-8bd5-85015a1567fe', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('0a883317-d6c0-44e1-93b2-ba531fa9eeab', 'Customer Churn Prediction', 'customer_churn_prediction', 'data_products', 'Predicts which customers are likely to leave using historical data.', customer_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into customer_churn_prediction;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (customer_churn_prediction, '<h2>Customer Churn Prediction</h2><p></p><p>This data product aims to anticipate customer attrition using predictive modeling.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Proactively engage at-risk customers</li><li>Reduce churn rates</li><li>Optimize retention strategies</li></ul>', 'ACTIVE', 'f1672c38-ad1a-401a-8dd3-e0b026ab1416', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('403d19c9-2056-4fb7-b820-d163df800e8f', 'Marketing Campaign Analysis', 'marketing_campaign_analysis', 'data_products', 'Evaluates the performance of marketing campaigns across channels.', customer_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into marketing_campaign_analysis;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (marketing_campaign_analysis, '<h2>Marketing Campaign Analysis</h2><p></p><p>This data product provides insights into marketing campaign effectiveness.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Measure ROI of campaigns</li><li>Identify best-performing channels</li><li>Support marketing optimization</li></ul>', 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('9a78d3cc-0c0d-4d0b-a314-aeb99c8cecf3', 'Customer Lifetime Value', 'customer_lifetime_value', 'data_products', 'Calculates expected revenue per customer over their relationship.', customer_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into customer_lifetime_value;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (customer_lifetime_value, '<h2>Customer Lifetime Value</h2><p></p><p>This data product estimates customer lifetime value to guide business decisions.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Prioritize high-value customers</li><li>Optimize marketing spend</li><li>Inform loyalty programs</li></ul>', 'ACTIVE', '3c289333-2d55-4aed-8bd5-85015a1567fe', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('66563731-1be2-493c-b692-aef4cc29e493', 'Customer Feedback Analysis', 'customer_feedback_analysis', 'data_products', 'Analyzes surveys and reviews to understand satisfaction and needs.', customer_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into customer_feedback_analysis;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (customer_feedback_analysis, '<h2>Customer Feedback Analysis</h2><p></p><p>This data product centralizes customer feedback analysis for actionable insights.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Understand customer satisfaction</li><li>Identify improvement areas</li><li>Support product and service enhancements</li></ul>', 'ACTIVE', '74b13338-aa85-4552-8ccb-7d51550c67de', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('65254a60-6f97-4b6c-812c-84dcf7c316e3', 'Inventory Management', 'inventory_management', 'data_products', 'Tracks stock levels, turnover, and replenishment schedules.', operations_and_logistics_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into inventory_management;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (inventory_management, '<h2>Inventory Management</h2><p></p><p>This data product provides a centralized platform for managing inventory efficiently.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Monitor stock levels in real-time</li><li>Reduce stockouts and overstock</li><li>Improve warehouse operations</li></ul>', 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('429f80cf-bce9-4ac5-bafc-0c153df466fc', 'Supply Chain Optimization', 'supply_chain_optimization', 'data_products', 'Analyzes supplier performance, delivery times, and transportation costs.', operations_and_logistics_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into supply_chain_optimization;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (supply_chain_optimization, '<h2>Supply Chain Optimization</h2><p></p><p>This data product aims to optimize supply chain efficiency across operations.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Track supplier performance</li><li>Reduce delivery delays</li><li>Minimize transportation costs</li></ul>', 'ACTIVE', '3c289333-2d55-4aed-8bd5-85015a1567fe', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('867e3ad0-7a11-4687-bd39-3e41ad9f2ed0', 'Warehouse Automation Metrics', 'warehouse_automation_metrics', 'data_products', 'Monitors efficiency of warehouse processes using sensor and IoT data.', operations_and_logistics_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into warehouse_automation_metrics;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (warehouse_automation_metrics, '<h2>Warehouse Automation Metrics</h2><p></p><p>This data product centralizes warehouse automation metrics for operational improvement.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Track process efficiency</li><li>Identify bottlenecks</li><li>Support automation initiatives</li></ul>', 'ACTIVE', 'f1672c38-ad1a-401a-8dd3-e0b026ab1416', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('c9940b6c-b0be-48d4-a546-cab8afa6cf4b', 'Order Fulfillment Analysis', 'order_fulfillment_analysis', 'data_products', 'Tracks order processing time and delivery success rates.', operations_and_logistics_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into order_fulfillment_analysis;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (order_fulfillment_analysis, '<h2>Order Fulfillment Analysis</h2><p></p><p>This data product provides visibility into order fulfillment performance.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Monitor processing times</li><li>Improve delivery success rates</li><li>Enhance customer satisfaction</li></ul>', 'ACTIVE', '3c289333-2d55-4aed-8bd5-85015a1567fe', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('c550880e-fcc8-4048-a6ce-fec8903b5521', 'Production Planning Insights', 'production_planning_insights', 'data_products', 'Predicts production needs and schedules resources effectively.', operations_and_logistics_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into production_planning_insights;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (production_planning_insights, '<h2>Production Planning Insights</h2><p></p><p>This data product centralizes production planning insights to optimize operations.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Forecast production requirements</li><li>Allocate resources efficiently</li><li>Reduce downtime</li></ul>', 'ACTIVE', '3c289333-2d55-4aed-8bd5-85015a1567fe', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('86b74246-734f-4cea-a984-3dd0d27fc565', 'Sales performance model', 'sales-performance-model', 'data_products', 'Evaluates sales productivity and regional performance.
    ...
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (sales_performance_model, NULL, 'ACTIVE', '90ab1128-329f-47dd-9420-c9681bfc68c4', data_product_lifecycle_id, NULL);
    ...
    -- Revenue dashboard
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('b976c1af-2199-420b-8e70-76b7ea4119ad', 'Revenue Dashboard', 'revenue_dashboard', 'data_products', 'Tracks revenue by product line, region, and period.', financial_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into revenue_dashboard;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (revenue_dashboard, '<h2>Revenue Dashboard</h2><p></p><p>This data product provides a consolidated view of company revenue.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Monitor revenue trends</li><li>Identify growth opportunities</li><li>Support strategic decision-making</li></ul>', 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', NULL, NULL);
    ...
    -- Expense forecasting
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES (gen_random_uuid(), 'Expense Forecasting', 'expense_forecasting', 'data_products', 'Predicts future expenses using historical financial data.', financial_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into expense_forecasting;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (expense_forecasting, '<h2>Expense Forecasting</h2><p></p><p>This data product enables proactive expense management through forecasting.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Anticipate future costs</li><li>Support budgeting and planning</li><li>Reduce financial risk</li></ul>', 'ACTIVE', 'f1672c38-ad1a-401a-8dd3-e0b026ab1416', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES (gen_random_uuid(), 'User Feedback Analysis', 'user_feedback_analysis', 'data_products', 'Uses text mining to extract insights from user reviews and surveys.', product_development_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into user_feedback_analysis;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (user_feedback_analysis, '<h2>User Feedback Analysis</h2><p></p><p>This data product enables centralized analysis of user feedback for product improvement.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Extract insights from reviews and surveys</li><li>Identify pain points</li><li>Inform UX and feature decisions</li></ul>', 'ACTIVE', 'f1672c38-ad1a-401a-8dd3-e0b026ab1416', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES (gen_random_uuid(), 'Release Impact Analysis', 'release_impact_analysis', 'data_products', 'Measures effect of new releases on usage and performance.', product_development_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into release_impact_analysis;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (release_impact_analysis, '<h2>Release Impact Analysis</h2><p></p><p>This data product centralizes insights on release impact for better planning.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Assess adoption of new features</li><li>Measure performance impact</li><li>Guide future release planning</li></ul>', 'ACTIVE', '3c289333-2d55-4aed-8bd5-85015a1567fe', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES (gen_random_uuid(), 'Data Privacy Compliance', 'data_privacy_compliance', 'data_products', 'Monitors adherence to GDPR and other privacy regulations.', risk_and_compliance_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into data_privacy_compliance;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (data_privacy_compliance, '<h2>Data Privacy Compliance</h2><p></p><p>This data product ensures compliance with data privacy regulations.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Monitor GDPR compliance</li><li>Identify gaps in privacy practices</li><li>Support regulatory reporting</li></ul>', 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES (gen_random_uuid(), 'Cash Flow Monitoring', 'cash_flow_monitoring', 'data_products', 'Monitors inflows and outflows of funds in real-time.', financial_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into cash_flow_monitoring;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (cash_flow_monitoring, '<h2>Cash Flow Monitoring</h2><p></p><p>This data product provides real-time cash flow monitoring for financial stability.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Track daily cash movements</li><li>Ensure liquidity and solvency</li><li>Support financial decision-making</li></ul>', 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', NULL, NULL);
    ...
    -- Fraud detection
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES (gen_random_uuid(), 'Fraud Detection', 'fraud_detection', 'data_products', 'Detects suspicious activities in transactions using historical patterns.', risk_and_compliance_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into fraud_detection;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (fraud_detection, '<h2>Fraud Detection</h2><p></p><p>This data product centralizes fraud detection insights for risk mitigation.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Identify suspicious transactions</li><li>Prevent financial losses</li><li>Support security investigations</li></ul>', 'ACTIVE', 'f1672c38-ad1a-401a-8dd3-e0b026ab1416', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES (gen_random_uuid(), 'Profitability Analysis', 'profitability_analysis', 'data_products', 'Identifies which products or services contribute most to profit.', financial_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into profitability_analysis;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (profitability_analysis, '<h2>Profitability Analysis</h2><p></p><p>This data product centralizes profitability insights to guide business strategy.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Identify high-margin products</li><li>Optimize product portfolio</li><li>Inform investment decisions</li></ul>', 'ACTIVE', '3c289333-2d55-4aed-8bd5-85015a1567fe', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES (gen_random_uuid(), 'Financial Risk Assessment', 'financial_risk_assessment', 'data_products', 'Evaluates potential financial risks and exposure.', financial_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into financial_risk_assessment;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (financial_risk_assessment, '<h2>Financial Risk Assessment</h2><p></p><p>This data product centralizes financial risk evaluation for proactive management.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Identify financial risks</li><li>Support compliance and regulatory requirements</li><li>Guide investment decisions</li></ul>', 'ACTIVE', '3c289333-2d55-4aed-8bd5-85015a1567fe', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES (gen_random_uuid(), 'Feature Usage Metrics', 'feature_usage_metrics', 'data_products', 'Tracks how often users engage with product features.', product_development_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into feature_usage_metrics;
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES (feature_usage_metrics, '<h2>Feature Usage Metrics</h2><p></p><p>This data product provides a centralized view of feature adoption and usage.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Monitor user engagement</li><li>Identify popular features</li><li>Inform product development priorities</li></ul>', 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', NULL, NULL);
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at)
        VALUES (gen_random_uuid(), 'CEO Question exploration', 'ceo_question_exploration', 'explorations', 'To answer a question from the CEO', customer_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into ceo_question;
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at)
        VALUES (gen_random_uuid(), 'COO Question exploration', 'coo_question_exploration', 'explorations', 'To answer a question from the COO', customer_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL) returning id into coo_question;
    ...
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('a8afca59-78ce-4808-adaa-8bbab998ac6d', 'A/B Test Results', 'a_b_test_results', 'data_products', 'Stores and analyzes experiments to optimize product decisions.', product_development_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL);
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('a8afca59-78ce-4808-adaa-8bbab998ac6d', '<h2>A/B Test Results</h2><p></p><p>This data product centralizes A/B testing results for actionable insights.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Compare feature variations</li><li>Measure impact on user behavior</li><li>Support data-driven product decisions</li></ul>', 'ACTIVE', '3c289333-2d55-4aed-8bd5-85015a1567fe', NULL, NULL);
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('16f9cdac-f0ab-45f9-84e1-fb28bf7eda2c', 'Product Performance Dashboard', 'product_performance_dashboard', 'data_products', 'Monitors KPIs like uptime, error rates, and adoption.', product_development_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL);
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('16f9cdac-f0ab-45f9-84e1-fb28bf7eda2c', '<h2>Product Performance Dashboard</h2><p></p><p>This data product provides a consolidated view of product performance metrics.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Track uptime and reliability</li><li>Monitor feature adoption</li><li>Support operational and strategic decisions</li></ul>', 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', NULL, NULL);
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('4bba2a03-b51c-4525-b094-1f85a3dba31b', 'Operational Risk Metrics', 'operational_risk_metrics', 'data_products', 'Evaluates risks in business processes to prevent disruptions.', risk_and_compliance_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL);
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('4bba2a03-b51c-4525-b094-1f85a3dba31b', '<h2>Operational Risk Metrics</h2><p></p><p>This data product provides centralized operational risk insights for mitigation.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Monitor business process risks</li><li>Identify vulnerabilities</li><li>Support operational continuity</li></ul>', 'ACTIVE', '3c289333-2d55-4aed-8bd5-85015a1567fe', NULL, NULL);
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('92eb574f-10ec-42dc-af72-05aa06cc8ade', 'Security Incident Reporting', 'security_incident_reporting', 'data_products', 'Tracks and analyzes security breaches and attempted attacks.', risk_and_compliance_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL);
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('92eb574f-10ec-42dc-af72-05aa06cc8ade', '<h2>Security Incident Reporting</h2><p></p><p>This data product centralizes reporting of security incidents for response.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Track security events</li><li>Analyze incident patterns</li><li>Support rapid mitigation actions</li></ul>', 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', NULL, NULL);
    INSERT INTO public.abstract_data_products (id, "name", namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('3a3dc97d-2278-42e8-8e72-dd923192a4df', 'Regulatory Audit Tracker', 'regulatory_audit_tracker', 'data_products', 'Monitors audit readiness and compliance with industry standards.', risk_and_compliance_domain_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL);
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('3a3dc97d-2278-42e8-8e72-dd923192a4df', '<h2>Regulatory Audit Tracker</h2><p></p><p>This data product provides a platform for tracking regulatory audit compliance.</p><p></p><p><strong>Key objectives include:</strong></p><ul><li>Monitor audit readiness</li><li>Ensure regulatory adherence</li><li>Support compliance reporting</li></ul>', 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', NULL, NULL);
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('81815c4c-f323-4cf1-b25b-f43f231f510f', 'Biomarker discovery', 'biomarker-discovery', 'data_products', 'Helps researchers identify molecular signatures linked to disease progression or drug response.
    ...
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('81815c4c-f323-4cf1-b25b-f43f231f510f', NULL, 'ACTIVE', '74b13338-aa85-4552-8ccb-7d51550c67de', data_product_lifecycle_id, NULL);
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('6e580d91-14ea-495e-a6d7-5db236a5c1d5', 'Clinical trial performance', 'clinical-trial-performance', 'data_products', 'Monitors progress, enrollment, and site efficiency for ongoing studies.
    ...
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('6e580d91-14ea-495e-a6d7-5db236a5c1d5', NULL, 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', data_product_lifecycle_id, NULL);
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('9fa5e299-fcc4-45e0-b48d-cc3deb68eefe', 'Clinical data quality monitor', 'clinical-data-quality-monitor', 'data_products', 'Automates validation and consistency checks for clinical data.
    ...
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('9fa5e299-fcc4-45e0-b48d-cc3deb68eefe', NULL, 'ACTIVE', '3c289333-2d55-4aed-8bd5-85015a1567fe', data_product_lifecycle_id, NULL);
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('fbcd7899-2763-4659-bd28-2a278910ef85', 'Regulatory submission tracker', 'regulatory-submission-tracker', 'data_products', 'Centralizes documentation and timelines for regulatory filings.
    ...
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('fbcd7899-2763-4659-bd28-2a278910ef85', NULL, 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', data_product_lifecycle_id, NULL);
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('08039e5d-50a7-447a-b691-f5dc6b420dea', 'Safety Signal Detection System', 'safety-signal-detection-system', 'data_products', 'Detects early signs of drug-related adverse effects from trial and post-market data.
    ...
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('08039e5d-50a7-447a-b691-f5dc6b420dea', NULL, 'ACTIVE', '90ab1128-329f-47dd-9420-c9681bfc68c4', data_product_lifecycle_id, NULL);
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('625b65b6-13d9-4c8c-a669-865e36fc3dfc', 'Drug Supply Chain Optimization', 'drug-supply-chain-optimization', 'data_products', 'Forecasts and manages inventory to avoid clinical supply shortages.
    ...
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('625b65b6-13d9-4c8c-a669-865e36fc3dfc', NULL, 'ACTIVE', 'f1672c38-ad1a-401a-8dd3-e0b026ab1416', data_product_lifecycle_id, NULL);
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('22488fe0-c30a-4447-972e-3eb22a1bd266', 'Customer intelligence platform', 'customer-intelligence-platform', 'data_products', 'Unifies healthcare professional and institutional engagement data.
    ...
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('22488fe0-c30a-4447-972e-3eb22a1bd266', NULL, 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', data_product_lifecycle_id, NULL);
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('90e65438-a942-43e0-a4a9-ee406b92df65', 'Enterprise knowledge graph', 'enterprise-knowledge-graph', 'data_products', 'Connects data entities (people, trials, compounds, documents) across all domains.
    ...
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('90e65438-a942-43e0-a4a9-ee406b92df65', NULL, 'ACTIVE', 'f1672c38-ad1a-401a-8dd3-e0b026ab1416', data_product_lifecycle_id, NULL);
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('68b28e38-3faa-45ca-9d00-3830d0a7b108', 'Employee productivity', 'employee-productivity', 'data_products', 'Measures how teams collaborate and deliver projects.
    It identifies factors influencing productivity and engagement.', customer_domain_id, '2025-10-28 18:14:07.371512', NULL, NULL);
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('68b28e38-3faa-45ca-9d00-3830d0a7b108', NULL, 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', data_product_lifecycle_id, NULL);
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('97af957a-70c4-465d-95f2-f70c11af8da0', 'DEI Insights Dashboard', 'dei-insights-dashboard', 'data_products', 'Monitors diversity, equity, and inclusion metrics across the organization.
    ...
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('97af957a-70c4-465d-95f2-f70c11af8da0', NULL, 'ACTIVE', '1b4a64b3-96fb-404c-a73c-294802dc9852', data_product_lifecycle_id, NULL);
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('58b837a5-33d0-41cf-bf95-eb9af846f4d0', 'Patient Stratification Engine', 'patient-stratification-engine', 'data_products', 'Identifies patient subgroups most likely to respond to therapies.
    ...
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('58b837a5-33d0-41cf-bf95-eb9af846f4d0', NULL, 'ACTIVE', '90ab1128-329f-47dd-9420-c9681bfc68c4', data_product_lifecycle_id, NULL);
    INSERT INTO public.abstract_data_products (id, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at) VALUES ('ccdc13fa-4a1a-4dde-ad1c-efa0d58eafb7', 'R&D Portfolio Prioritization Model', 'rd-portfolio-prioritization-model', 'data_products', 'Ranks R&D projects based on scientific potential, ROI, and strategic fit.
    ...
    INSERT INTO public.data_products (id, about, status, type_id, lifecycle_id, usage) VALUES ('ccdc13fa-4a1a-4dde-ad1c-efa0d58eafb7', NULL, 'ACTIVE', 'f1672c38-ad1a-401a-8dd3-e0b026ab1416', data_product_lifecycle_id, NULL);
