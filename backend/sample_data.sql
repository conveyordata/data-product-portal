...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('0deeb253-7b8c-4ece-8a9c-29524bbc5c00', 'campaign_performance_summary', '{{ marketing_campaign_analysis }}'::uuid, 'Campaign Performance Summary', 'KPIs for each marketing campaign', 'Provides campaign results to optimize channel strategy and improve customer retention. Key objectives: - Track ROI - Identify best-performing campaigns - Inform budget allocation', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('22b583ce-d052-49b3-98c9-92483282f303', 'customer_lifetime_value_scores', '{{ customer_lifetime_value }}'::uuid, 'Customer Lifetime Value Scores', 'Predicted lifetime value per customer', 'Provides metrics to prioritize high-value customers. Key objectives: - Guide marketing spend - Support sales strategy - Inform loyalty programs', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('e2a641fc-c9ef-40a2-98be-76a7585db5d6', 'feature_feedback_ranking', '{{ customer_feedback_analysis }}'::uuid, 'Feature Feedback Ranking', 'Ranked insights about product features from user feedback', 'Combines usage metrics with feedback to understand feature impact. Key objectives: - Highlight areas for product improvement - Guide roadmap prioritization - Support UX decisions', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('{{ inventory_management_output_port }}'::uuid, 'inventory_status', '65254a60-6f97-4b6c-812c-84dcf7c316e3', 'Inventory Status', 'Current stock levels per warehouse', 'Provides visibility into inventory to prevent stockouts or overstock. Key objectives: - Monitor stock levels - Support replenishment planning - Reduce costs', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('05ae0792-f70a-422c-abc1-16fd8c9348bb', 'warehouse_efficiency_metrics', '{{ warehouse_automation_metrics }}'::uuid, 'Warehouse Efficiency Metrics', 'KPIs from automated warehouse operations', 'Provides data to improve operational efficiency. Key objectives: - Identify bottlenecks - Measure automation impact - Support resource allocation', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);

INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('4c4ff241-9885-48eb-8b2a-b1a1d66092a3', 'automated_pick_pack_rates', '{{ warehouse_automation_metrics }}'::uuid, 'Automated Pick Pack Rates', 'Metrics for automated picking and packing', 'Provides detailed operational data for efficiency optimization. Key objectives: - Track speed and accuracy - Support automation planning - Reduce operational costs', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('{{ order_fulfillment_analysis_output_port }}'::uuid, 'order_fulfillment_stats', '{{ order_fulfillment_analysis }}'::uuid, 'Order Fulfillment Stats', 'Metrics on order processing and delivery success', 'Provides visibility into fulfillment performance. Key objectives: - Track delivery efficiency - Improve customer satisfaction - Reduce delays', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('{{ production_planning_insights_forecast }}'::uuid, 'production_planning_forecast', '{{ production_planning_insights }}'::uuid, 'Production Planning Forecast', 'Forecast of production requirements', 'Provides projections to optimize scheduling and capacity. Key objectives: - Reduce downtime - Optimize resource allocation - Support operational planning', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);

INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('bc7b3d51-1941-4312-ba83-4594c331cf05', 'production_variance_report', '{{ production_planning_insights }}'::uuid, 'Production Variance Report', 'Difference between planned and actual production', 'Provides insights into production deviations. Key objectives: - Identify inefficiencies - Improve planning accuracy - Support operations', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('{{ sales_performance_model_output_port }}'::uuid, 'sales_performance', '{{ sales_performance_model }}'::uuid, 'Sales performance', 'Sales performance data', 'Provides an overview of sales performance data', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('b076bf53-463a-47bb-84a9-596d45b425d7', 'revenue_dashboard_summary', '{{ revenue_dashboard }}'::uuid, 'Revenue Dashboard Summary', 'Consolidated revenue metrics', 'Provides a single view of revenue trends. Key objectives: - Track revenue by product and region - Identify growth opportunities - Support executive reporting', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('d4e7792b-fb93-4541-beb9-b3c2b2474c77', 'expense_forecast', '{{ expense_forecasting }}'::uuid, 'Expense Forecast', 'Predicted expenses by category', 'Provides insight into expected costs to support budgeting. Key objectives: - Forecast future expenses - Support planning - Reduce financial risk', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('{{ user_feedback_insights_report }}'::uuid, 'feedback_insights_report', '{{ user_feedback_analysis }}'::uuid, 'Feedback Insights Report', 'Summarized insights from user feedback', 'Provides actionable insights for product improvements. Key objectives: - Identify pain points - Prioritize changes - Improve satisfaction', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('{{ release_engagement_by_segment }}'::uuid, 'release_engagement_by_segment', '{{ release_impact_analysis }}'::uuid, 'Release Engagement By Segment', 'Feature adoption per customer segment', 'Helps measure differential impact of releases across user groups. Key objectives: - Understand segment behavior - Inform targeted communications - Optimize rollout', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);

INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('{{ release_impact_summary }}'::uuid, 'release_impact_summary', '{{ release_impact_analysis }}'::uuid, 'Release Impact Summary', 'Metrics on usage changes after new releases', 'Provides insight into feature release performance. Key objectives: - Measure adoption - Detect regressions - Inform next releases', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('{{ dei_insights_dashboard_ds }}'::uuid, 'dei_insights_dashboard', '{{ dei_insights_dashboard }}'::uuid, 'DEI Insights dashboard', 'Insights into DEI at the company', 'Provides insights into DEI at the company', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('e94890c6-0da8-4a1e-b696-e53e5312f743', 'privacy_compliance_report', '{{ data_privacy_compliance }}'::uuid, 'Privacy Compliance Report', 'GDPR and privacy compliance metrics', 'Provides compliance tracking for regulatory adherence. Key objectives: - Identify gaps - Support audits - Ensure legal compliance', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('dcb24163-bfec-44d8-b025-1d656d0fff36', 'cash_flow_overview', '{{ cash_flow_monitoring }}'::uuid, 'Cash Flow Overview', 'Daily inflows and outflows', 'Provides real-time view of cash position. Key objectives: - Ensure liquidity - Identify gaps - Support financial planning', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES (gen_random_uuid(), 'profitability_analysis_report', '{{ profitability_analysis }}'::uuid, 'Profitability Analysis Report', 'Product and service profit contribution', 'Provides insight into profitability for portfolio decisions. Key objectives: - Identify high-margin offerings - Guide investment strategy - Support executive decisions', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);

INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('{{ margin_trends_by_product }}'::uuid, 'margin_trends_by_product', '{{ profitability_analysis }}'::uuid, 'Margin Trends By Product', 'Historical margin trends per product', 'Provides deeper understanding of profitability over time. Key objectives: - Detect declining margins - Inform pricing strategies - Support product decisions', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES (gen_random_uuid(), 'financial_risk_dashboard', '{{ financial_risk_assessment }}'::uuid, 'Financial Risk Dashboard', 'Metrics highlighting financial exposure', 'Provides risk analysis to prevent losses. Key objectives: - Track financial risks - Support mitigation strategies - Enable compliance', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('{{ feature_usage_metrics_daily }}'::uuid, 'daily_feature_engagement', '{{ feature_usage_metrics }}'::uuid, 'Daily Feature Engagement', 'Daily usage metrics per feature', 'Provides insights into feature adoption. Key objectives: - Monitor engagement - Guide product improvements - Track trends', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);

INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, deleted_at) VALUES ('{{ feature_usage_metrics_weekly }}'::uuid, 'weekly_feature_summary', '{{ feature_usage_metrics }}'::uuid, 'Weekly Feature Summary', 'Aggregated weekly feature usage', 'Provides weekly trends for product teams. Key objectives: - Identify adoption patterns - Support roadmap planning - Enable executive reporting', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
...
VALUES ('22222222-2222-4222-8222-222222222222', 'cafeteria_menu_rotation', '{{ dei_insights_dashboard }}'::uuid, 'Cafeteria Menu Rotation', 'Weekly rotating lunch menu options for the office cafeteria', 'Output port showcasing all access renewal states from the producer side.', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, NULL);
