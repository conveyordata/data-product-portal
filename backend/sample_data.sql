...
-- Schema visualisation demo: the portal's own full database schema
-- (every table in backend/app/database, introspected via information_schema) for prototyping the ER diagram.
INSERT INTO public.abstract_data_products (id, status, finalizers, name, namespace, abstract_data_product_type, description, domain_id, created_on, updated_on, deleted_at)
VALUES ('{{ demo_schema_visualisation }}'::uuid, 'active', '{}', 'Schema Visualisation Demo', 'schema_visualisation_demo', 'data_products', 'Demo data product exposing the portal''s own core data model, used to prototype the output port ER diagram.', '{{ customer_domain_id }}'::uuid, timezone('utc'::text, current_timestamp), NULL, NULL);
...
INSERT INTO public.datasets (id, namespace, data_product_id, name, description, about, status, access_type, created_on, updated_on, lifecycle_id, deleted_at)
VALUES ('{{ demo_schema_visualisation_output_port }}'::uuid, 'demo_schema_visualisation', '{{ demo_schema_visualisation }}'::uuid, 'Demo Schema Visualisation', 'The portal''s own full database schema, every table and foreign key', 'Dataset modelling the portal''s own schema, used to exercise table-relationship visualisation.', 'ACTIVE', 'RESTRICTED', timezone('utc'::text, current_timestamp), NULL, '{{ data_product_lifecycle_id }}'::uuid, NULL);
...
INSERT INTO public.output_port_schema_objects (id, output_port_id, name, physical_name, logical_type, physical_type, description, position)
VALUES
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'abstract_data_products', 'abstract_data_products', 'table', 'table', 'Abstract data products', 1),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'access_durations', 'access_durations', 'table', 'table', 'Access durations', 2),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'access_modes', 'access_modes', 'table', 'table', 'Access modes', 3),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'azure_blob_technical_asset_configurations', 'azure_blob_technical_asset_configurations', 'table', 'table', 'Azure blob technical asset configurations', 4),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'data_output_configurations', 'data_output_configurations', 'table', 'table', 'Data output configurations', 5),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'data_outputs', 'data_outputs', 'table', 'table', 'Data outputs', 6),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'data_outputs_datasets', 'data_outputs_datasets', 'table', 'table', 'Data outputs datasets', 7),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'data_product_lifecycles', 'data_product_lifecycles', 'table', 'table', 'Data product lifecycles', 8),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'data_product_settings', 'data_product_settings', 'table', 'table', 'Data product settings', 9),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'data_product_types', 'data_product_types', 'table', 'table', 'Data product types', 10),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'data_products', 'data_products', 'table', 'table', 'Data products', 11),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'data_products_settings_values', 'data_products_settings_values', 'table', 'table', 'Data products settings values', 12),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'data_quality_technical_assets', 'data_quality_technical_assets', 'table', 'table', 'Data quality technical assets', 13),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'databricks_technical_asset_configurations', 'databricks_technical_asset_configurations', 'table', 'table', 'Databricks technical asset configurations', 14),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'dataset_curated_queries', 'dataset_curated_queries', 'table', 'table', 'Dataset curated queries', 15),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'dataset_query_stats_daily', 'dataset_query_stats_daily', 'table', 'table', 'Dataset query stats daily', 16),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'datasets', 'datasets', 'table', 'table', 'Datasets', 17),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'deprecated_data_outputs_datasets', 'deprecated_data_outputs_datasets', 'table', 'table', 'Deprecated data outputs datasets', 18),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'deprecated_data_products_datasets', 'deprecated_data_products_datasets', 'table', 'table', 'Deprecated data products datasets', 19),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'deprecated_datasets', 'deprecated_datasets', 'table', 'table', 'Deprecated datasets', 20),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'deprecated_tags_datasets', 'deprecated_tags_datasets', 'table', 'table', 'Deprecated tags datasets', 21),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'device_flows', 'device_flows', 'table', 'table', 'Device flows', 22),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'domains', 'domains', 'table', 'table', 'Domains', 23),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'env_platform_configs', 'env_platform_configs', 'table', 'table', 'Env platform configs', 24),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'env_platform_service_configs', 'env_platform_service_configs', 'table', 'table', 'Env platform service configs', 25),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'environments', 'environments', 'table', 'table', 'Environments', 26),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'event_reference_entities', 'event_reference_entities', 'table', 'table', 'Event reference entities', 27),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'events', 'events', 'table', 'table', 'Events', 28),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'explorations', 'explorations', 'table', 'table', 'Explorations', 29),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'glue_technical_asset_configurations', 'glue_technical_asset_configurations', 'table', 'table', 'Glue technical asset configurations', 30),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'input_port_requests', 'input_port_requests', 'table', 'table', 'Input port requests', 31),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'input_ports', 'input_ports', 'table', 'table', 'Input ports', 32),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'notifications', 'notifications', 'table', 'table', 'Notifications', 33),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'osi_semantic_model_technical_asset_configurations', 'osi_semantic_model_technical_asset_configurations', 'table', 'table', 'Osi semantic model technical asset configurations', 34),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'output_port_data_quality_summaries', 'output_port_data_quality_summaries', 'table', 'table', 'Output port data quality summaries', 35),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'output_port_schema_objects', 'output_port_schema_objects', 'table', 'table', 'Output port schema objects', 36),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'output_port_schema_properties', 'output_port_schema_properties', 'table', 'table', 'Output port schema properties', 37),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'output_port_schema_relationships', 'output_port_schema_relationships', 'table', 'table', 'Output port schema relationships', 38),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'platform_service_configs', 'platform_service_configs', 'table', 'table', 'Platform service configs', 39),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'platform_services', 'platform_services', 'table', 'table', 'Platform services', 40),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'platforms', 'platforms', 'table', 'table', 'Platforms', 41),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'postgresql_technical_asset_configurations', 'postgresql_technical_asset_configurations', 'table', 'table', 'Postgresql technical asset configurations', 42),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'redshift_technical_asset_configurations', 'redshift_technical_asset_configurations', 'table', 'table', 'Redshift technical asset configurations', 43),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'role_assignments_data_product', 'role_assignments_data_product', 'table', 'table', 'Role assignments data product', 44),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'role_assignments_dataset', 'role_assignments_dataset', 'table', 'table', 'Role assignments dataset', 45),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'role_assignments_global', 'role_assignments_global', 'table', 'table', 'Role assignments global', 46),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'roles', 'roles', 'table', 'table', 'Roles', 47),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'rustfs_technical_asset_configurations', 'rustfs_technical_asset_configurations', 'table', 'table', 'Rustfs technical asset configurations', 48),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 's3_technical_asset_configurations', 's3_technical_asset_configurations', 'table', 'table', 'S3 technical asset configurations', 49),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'snowflake_technical_asset_configurations', 'snowflake_technical_asset_configurations', 'table', 'table', 'Snowflake technical asset configurations', 50),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'tags', 'tags', 'table', 'table', 'Tags', 51),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'tags_data_outputs', 'tags_data_outputs', 'table', 'table', 'Tags data outputs', 52),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'tags_data_products', 'tags_data_products', 'table', 'table', 'Tags data products', 53),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'tags_datasets', 'tags_datasets', 'table', 'table', 'Tags datasets', 54),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'technical_asset_access_modes', 'technical_asset_access_modes', 'table', 'table', 'Technical asset access modes', 55),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'theme_settings', 'theme_settings', 'table', 'table', 'Theme settings', 56),
(gen_random_uuid(), '{{ demo_schema_visualisation_output_port }}'::uuid, 'users', 'users', 'table', 'table', 'Users', 57);
...
SELECT
    ...
    p.required,
    p.partitioned,
    p.partition_key_position::smallint,
    p.primary_key_position,
    p.description,
    p.examples::jsonb,
    p.position
...
INNER JOIN (
    VALUES
    ('abstract_data_products', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('abstract_data_products', 'name', 'Name', 'string', 'VARCHAR', FALSE, TRUE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('abstract_data_products', 'abstract_data_product_type', 'Abstract Data Product Type', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('abstract_data_products', 'description', 'Description', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('abstract_data_products', 'namespace', 'Namespace', 'string', 'VARCHAR', FALSE, TRUE, TRUE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('abstract_data_products', 'domain_id', 'Domain Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('abstract_data_products', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('abstract_data_products', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('abstract_data_products', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('abstract_data_products', 'finalizers', 'Finalizers', 'array', 'VARCHAR[]', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('abstract_data_products', 'status', 'Status', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('access_durations', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('access_durations', 'abstract_data_product_type', 'Abstract Data Product Type', 'string', 'VARCHAR', FALSE, TRUE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('access_durations', 'access_duration_type', 'Access Duration Type', 'string', 'VARCHAR', FALSE, TRUE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('access_durations', 'days', 'Days', 'integer', 'INTEGER', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('access_durations', 'is_default', 'Is Default', 'boolean', 'BOOLEAN', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('access_durations', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('access_durations', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('access_modes', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('access_modes', 'name', 'Name', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('access_modes', 'description', 'Description', 'string', 'TEXT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('access_modes', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('access_modes', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('access_modes', 'technical_asset_types', 'Technical Asset Types', 'array', 'TEXT[]', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('azure_blob_technical_asset_configurations', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('azure_blob_technical_asset_configurations', 'domain', 'Domain', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('azure_blob_technical_asset_configurations', 'container_name', 'Container Name', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('azure_blob_technical_asset_configurations', 'path', 'Path', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('azure_blob_technical_asset_configurations', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('azure_blob_technical_asset_configurations', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('azure_blob_technical_asset_configurations', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('data_output_configurations', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('data_output_configurations', 'configuration_type', 'Configuration Type', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('data_output_configurations', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('data_output_configurations', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 13),
    ('data_output_configurations', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 14),
    ('data_outputs', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('data_outputs', 'namespace', 'Namespace', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('data_outputs', 'name', 'Name', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('data_outputs', 'description', 'Description', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('data_outputs', 'status', 'Status', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('data_outputs', 'platform_id', 'Platform Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('data_outputs', 'service_id', 'Service Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('data_outputs', 'owner_id', 'Owner Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('data_outputs', 'configuration', 'Configuration', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('data_outputs', 'configuration_id', 'Configuration Id', 'string', 'UUID', FALSE, TRUE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('data_outputs', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('data_outputs', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 13),
    ('data_outputs', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 14),
    ('data_outputs', 'technical_mapping', 'Technical Mapping', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 16),
    ('data_outputs_datasets', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('data_outputs_datasets', 'data_output_id', 'Data Output Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('data_outputs_datasets', 'dataset_id', 'Dataset Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('data_outputs_datasets', 'status', 'Status', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('data_outputs_datasets', 'requested_by_id', 'Requested By Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('data_outputs_datasets', 'requested_on', 'Requested On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('data_outputs_datasets', 'approved_by_id', 'Approved By Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('data_outputs_datasets', 'approved_on', 'Approved On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('data_outputs_datasets', 'denied_by_id', 'Denied By Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('data_outputs_datasets', 'denied_on', 'Denied On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('data_outputs_datasets', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('data_outputs_datasets', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('data_outputs_datasets', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 13),
    ('data_product_lifecycles', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('data_product_lifecycles', 'name', 'Name', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('data_product_lifecycles', 'value', 'Value', 'integer', 'INTEGER', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('data_product_lifecycles', 'color', 'Color', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('data_product_lifecycles', 'is_default', 'Is Default', 'boolean', 'BOOLEAN', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('data_product_lifecycles', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('data_product_lifecycles', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('data_product_lifecycles', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('data_product_settings', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('data_product_settings', 'name', 'Name', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('data_product_settings', 'namespace', 'Namespace', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('data_product_settings', 'tooltip', 'Tooltip', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('data_product_settings', 'type', 'Type', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('data_product_settings', 'category', 'Category', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('data_product_settings', 'default', 'Default', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('data_product_settings', 'order', 'Order', 'integer', 'INTEGER', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('data_product_settings', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('data_product_settings', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('data_product_settings', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('data_product_settings', 'scope', 'Scope', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('data_product_types', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('data_product_types', 'name', 'Name', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('data_product_types', 'description', 'Description', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('data_product_types', 'icon_key', 'Icon Key', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('data_product_types', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('data_product_types', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('data_product_types', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('data_products', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('data_products', 'about', 'About', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('data_products', 'type_id', 'Type Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('data_products', 'lifecycle_id', 'Lifecycle Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('data_products', 'usage', 'Usage', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 13),
    ('data_products', 'visibility', 'Visibility', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 14),
    ('data_products_settings_values', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('data_products_settings_values', 'data_product_id', 'Data Product Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('data_products_settings_values', 'data_product_setting_id', 'Data Product Setting Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('data_products_settings_values', 'value', 'Value', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('data_products_settings_values', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('data_products_settings_values', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('data_products_settings_values', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('data_products_settings_values', 'dataset_id', 'Dataset Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('data_quality_technical_assets', 'name', 'Name', 'string', 'TEXT', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('data_quality_technical_assets', 'status', 'Status', 'string', 'TEXT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('data_quality_technical_assets', 'data_quality_summary_id', 'Data Quality Summary Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 2, NULL, NULL, 3),
    ('databricks_technical_asset_configurations', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('databricks_technical_asset_configurations', 'catalog', 'Catalog', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('databricks_technical_asset_configurations', 'schema', 'Schema', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('databricks_technical_asset_configurations', 'bucket_identifier', 'Bucket Identifier', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('databricks_technical_asset_configurations', 'catalog_path', 'Catalog Path', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('databricks_technical_asset_configurations', 'table', 'Table', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('databricks_technical_asset_configurations', 'table_path', 'Table Path', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('databricks_technical_asset_configurations', 'access_granularity', 'Access Granularity', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('databricks_technical_asset_configurations', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('databricks_technical_asset_configurations', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('databricks_technical_asset_configurations', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('dataset_curated_queries', 'output_port_id', 'Output Port Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('dataset_curated_queries', 'sort_order', 'Sort Order', 'integer', 'SMALLINT', TRUE, TRUE, TRUE, FALSE, NULL, 2, NULL, NULL, 2),
    ('dataset_curated_queries', 'title', 'Title', 'string', 'TEXT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('dataset_curated_queries', 'description', 'Description', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('dataset_curated_queries', 'query_text', 'Query Text', 'string', 'TEXT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('dataset_curated_queries', 'created_at', 'Created At', 'datetime', 'TIMESTAMPTZ', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('dataset_curated_queries', 'updated_at', 'Updated At', 'datetime', 'TIMESTAMPTZ', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('dataset_query_stats_daily', 'date', 'Date', 'date', 'DATE', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('dataset_query_stats_daily', 'dataset_id', 'Dataset Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 2, NULL, NULL, 2),
    ('dataset_query_stats_daily', 'consumer_data_product_id', 'Consumer Data Product Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 3, NULL, NULL, 3),
    ('dataset_query_stats_daily', 'query_count', 'Query Count', 'integer', 'INTEGER', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('datasets', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('datasets', 'namespace', 'Namespace', 'string', 'VARCHAR', FALSE, TRUE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('datasets', 'name', 'Name', 'string', 'VARCHAR', FALSE, TRUE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('datasets', 'description', 'Description', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('datasets', 'about', 'About', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('datasets', 'status', 'Status', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('datasets', 'access_type', 'Access Type', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('datasets', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('datasets', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('datasets', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('datasets', 'lifecycle_id', 'Lifecycle Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('datasets', 'usage', 'Usage', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 13),
    ('datasets', 'data_product_id', 'Data Product Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 14),
    ('datasets', 'search_vector', 'Search Vector', 'string', 'TSVECTOR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 15),
    ('datasets', 'embeddings', 'Embeddings', 'array', 'VECTOR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 16),
    ('datasets', 'data_product_access_duration_type', 'Data Product Access Duration Type', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 17),
    ('datasets', 'exploration_access_duration_type', 'Exploration Access Duration Type', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 18),
    ('deprecated_data_outputs_datasets', 'data_output_id', 'Data Output Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('deprecated_data_outputs_datasets', 'dataset_id', 'Dataset Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 2, NULL, NULL, 2),
    ('deprecated_data_outputs_datasets', 'requested_on', 'Requested On', 'datetime', 'TIMESTAMP', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('deprecated_data_outputs_datasets', 'deprecated_on', 'Deprecated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('deprecated_data_products_datasets', 'data_product_id', 'Data Product Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('deprecated_data_products_datasets', 'dataset_id', 'Dataset Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 2, NULL, NULL, 2),
    ('deprecated_data_products_datasets', 'deprecated_on', 'Deprecated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('deprecated_datasets', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('deprecated_datasets', 'name', 'Name', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('deprecated_datasets', 'description', 'Description', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('deprecated_datasets', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('deprecated_datasets', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('deprecated_datasets', 'deprecated_on', 'Deprecated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('deprecated_datasets', 'reason', 'Reason', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('deprecated_tags_datasets', 'tag_id', 'Tag Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('deprecated_tags_datasets', 'dataset_id', 'Dataset Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 2, NULL, NULL, 2),
    ('deprecated_tags_datasets', 'deprecated_on', 'Deprecated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('device_flows', 'device_code', 'Device Code', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('device_flows', 'user_code', 'User Code', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('device_flows', 'scope', 'Scope', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('device_flows', 'interval', 'Interval', 'integer', 'INTEGER', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('device_flows', 'expiration', 'Expiration', 'integer', 'INTEGER', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('device_flows', 'status', 'Status', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('device_flows', 'client_id', 'Client Id', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('device_flows', 'max_expiry', 'Max Expiry', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('device_flows', 'last_checked', 'Last Checked', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('device_flows', 'oidc_redirect_uri', 'Oidc Redirect Uri', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('device_flows', 'authz_code', 'Authz Code', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('device_flows', 'authz_verif', 'Authz Verif', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('device_flows', 'authz_state', 'Authz State', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 13),
    ('device_flows', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 14),
    ('device_flows', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 15),
    ('device_flows', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 16),
    ('domains', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('domains', 'name', 'Name', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('domains', 'description', 'Description', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('domains', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('domains', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('domains', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('env_platform_configs', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('env_platform_configs', 'environment_id', 'Environment Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('env_platform_configs', 'platform_id', 'Platform Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('env_platform_configs', 'config', 'Config', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('env_platform_configs', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('env_platform_configs', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('env_platform_configs', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('env_platform_service_configs', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('env_platform_service_configs', 'platform_id', 'Platform Id', 'string', 'UUID', FALSE, TRUE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('env_platform_service_configs', 'service_id', 'Service Id', 'string', 'UUID', FALSE, TRUE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('env_platform_service_configs', 'config', 'Config', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('env_platform_service_configs', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('env_platform_service_configs', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('env_platform_service_configs', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, TRUE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('env_platform_service_configs', 'environment_id', 'Environment Id', 'string', 'UUID', FALSE, TRUE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('environments', 'name', 'Name', 'string', 'VARCHAR', FALSE, TRUE, TRUE, FALSE, NULL, NULL, NULL, NULL, 1),
    ('environments', 'is_default', 'Is Default', 'boolean', 'BOOLEAN', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('environments', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('environments', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('environments', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('environments', 'context', 'Context', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('environments', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 8),
    ('environments', 'acronym', 'Acronym', 'string', 'VARCHAR', FALSE, TRUE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('event_reference_entities', 'key', 'Key', 'string', 'VARCHAR', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('events', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('events', 'name', 'Name', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('events', 'subject_id', 'Subject Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('events', 'target_id', 'Target Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('events', 'subject_type', 'Subject Type', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('events', 'target_type', 'Target Type', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('events', 'deleted_subject_identifier', 'Deleted Subject Identifier', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('events', 'deleted_target_identifier', 'Deleted Target Identifier', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('events', 'actor_id', 'Actor Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('events', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('events', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('events', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('explorations', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('explorations', 'owner_id', 'Owner Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('glue_technical_asset_configurations', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('glue_technical_asset_configurations', 'database', 'Database', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('glue_technical_asset_configurations', 'database_suffix', 'Database Suffix', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('glue_technical_asset_configurations', 'table', 'Table', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('glue_technical_asset_configurations', 'bucket_identifier', 'Bucket Identifier', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('glue_technical_asset_configurations', 'database_path', 'Database Path', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('glue_technical_asset_configurations', 'table_path', 'Table Path', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('glue_technical_asset_configurations', 'access_granularity', 'Access Granularity', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('glue_technical_asset_configurations', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('glue_technical_asset_configurations', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('glue_technical_asset_configurations', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('input_port_requests', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('input_port_requests', 'input_port_id', 'Input Port Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('input_port_requests', 'decision', 'Decision', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('input_port_requests', 'justification', 'Justification', 'string', 'TEXT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('input_port_requests', 'decision_note', 'Decision Note', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('input_port_requests', 'access_duration_type', 'Access Duration Type', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('input_port_requests', 'requested_duration_days', 'Requested Duration Days', 'integer', 'INTEGER', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('input_port_requests', 'requested_by_id', 'Requested By Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('input_port_requests', 'requested_on', 'Requested On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('input_port_requests', 'decided_by_id', 'Decided By Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('input_port_requests', 'decided_on', 'Decided On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('input_port_requests', 'valid_from', 'Valid From', 'date', 'DATE', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('input_port_requests', 'valid_until', 'Valid Until', 'date', 'DATE', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 13),
    ('input_port_requests', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 14),
    ('input_port_requests', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 15),
    ('input_port_requests', 'revoked_at', 'Revoked At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 16),
    ('input_port_requests', 'revoked_by_id', 'Revoked By Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 17),
    ('input_port_requests', 'access_mode_id', 'Access Mode Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 18),
    ('input_ports', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('input_ports', 'consuming_abstract_data_product_id', 'Consuming Abstract Data Product Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('input_ports', 'dataset_id', 'Dataset Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('input_ports', 'status', 'Status', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('input_ports', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('input_ports', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('input_ports', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 13),
    ('notifications', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('notifications', 'event_id', 'Event Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('notifications', 'user_id', 'User Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('notifications', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('notifications', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('notifications', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('osi_semantic_model_technical_asset_configurations', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('osi_semantic_model_technical_asset_configurations', 'model_name', 'Model Name', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('osi_semantic_model_technical_asset_configurations', 'location', 'Location', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('osi_semantic_model_technical_asset_configurations', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('osi_semantic_model_technical_asset_configurations', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('osi_semantic_model_technical_asset_configurations', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('output_port_data_quality_summaries', 'output_port_id', 'Output Port Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 1),
    ('output_port_data_quality_summaries', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 2),
    ('output_port_data_quality_summaries', 'assets_with_checks', 'Assets With Checks', 'integer', 'SMALLINT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('output_port_data_quality_summaries', 'assets_with_issues', 'Assets With Issues', 'integer', 'SMALLINT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('output_port_data_quality_summaries', 'details_url', 'Details Url', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('output_port_data_quality_summaries', 'description', 'Description', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('output_port_data_quality_summaries', 'overall_status', 'Overall Status', 'string', 'TEXT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('output_port_data_quality_summaries', 'created_at', 'Created At', 'datetime', 'TIMESTAMPTZ', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('output_port_data_quality_summaries', 'dimensions', 'Dimensions', 'object', 'JSON', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('output_port_schema_objects', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('output_port_schema_objects', 'output_port_id', 'Output Port Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('output_port_schema_objects', 'name', 'Name', 'string', 'TEXT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('output_port_schema_objects', 'logical_type', 'Logical Type', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('output_port_schema_objects', 'physical_type', 'Physical Type', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('output_port_schema_objects', 'physical_name', 'Physical Name', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('output_port_schema_objects', 'description', 'Description', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('output_port_schema_objects', 'position', 'Position', 'integer', 'SMALLINT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('output_port_schema_properties', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('output_port_schema_properties', 'schema_object_id', 'Schema Object Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('output_port_schema_properties', 'parent_property_id', 'Parent Property Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('output_port_schema_properties', 'name', 'Name', 'string', 'TEXT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('output_port_schema_properties', 'business_name', 'Business Name', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('output_port_schema_properties', 'logical_type', 'Logical Type', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('output_port_schema_properties', 'physical_type', 'Physical Type', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('output_port_schema_properties', 'description', 'Description', 'string', 'TEXT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('output_port_schema_properties', 'required', 'Required', 'boolean', 'BOOLEAN', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('output_port_schema_properties', 'unique', 'Unique', 'boolean', 'BOOLEAN', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('output_port_schema_properties', 'primary_key', 'Primary Key', 'boolean', 'BOOLEAN', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('output_port_schema_properties', 'partitioned', 'Partitioned', 'boolean', 'BOOLEAN', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('output_port_schema_properties', 'partition_key_position', 'Partition Key Position', 'integer', 'SMALLINT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 13),
    ('output_port_schema_properties', 'primary_key_position', 'Primary Key Position', 'integer', 'SMALLINT', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 14),
    ('output_port_schema_properties', 'examples', 'Examples', 'object', 'JSON', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 15),
    ('output_port_schema_properties', 'position', 'Position', 'integer', 'SMALLINT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 16),
    ('output_port_schema_relationships', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('output_port_schema_relationships', 'source_property_id', 'Source Property Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('output_port_schema_relationships', 'target_property_id', 'Target Property Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('output_port_schema_relationships', 'type', 'Type', 'string', 'TEXT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('platform_service_configs', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('platform_service_configs', 'platform_id', 'Platform Id', 'string', 'UUID', FALSE, TRUE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('platform_service_configs', 'service_id', 'Service Id', 'string', 'UUID', FALSE, TRUE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('platform_service_configs', 'config', 'Config', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('platform_service_configs', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('platform_service_configs', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('platform_service_configs', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, TRUE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('platform_services', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('platform_services', 'name', 'Name', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('platform_services', 'platform_id', 'Platform Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('platform_services', 'result_string_template', 'Result String Template', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('platform_services', 'technical_info_template', 'Technical Info Template', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('platforms', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('platforms', 'name', 'Name', 'string', 'VARCHAR', FALSE, TRUE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('postgresql_technical_asset_configurations', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('postgresql_technical_asset_configurations', 'database', 'Database', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('postgresql_technical_asset_configurations', 'schema', 'Schema', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('postgresql_technical_asset_configurations', 'table', 'Table', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('postgresql_technical_asset_configurations', 'access_granularity', 'Access Granularity', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('postgresql_technical_asset_configurations', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('postgresql_technical_asset_configurations', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('postgresql_technical_asset_configurations', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('redshift_technical_asset_configurations', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('redshift_technical_asset_configurations', 'database', 'Database', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('redshift_technical_asset_configurations', 'schema', 'Schema', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('redshift_technical_asset_configurations', 'table', 'Table', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('redshift_technical_asset_configurations', 'bucket_identifier', 'Bucket Identifier', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('redshift_technical_asset_configurations', 'database_path', 'Database Path', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('redshift_technical_asset_configurations', 'table_path', 'Table Path', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('redshift_technical_asset_configurations', 'access_granularity', 'Access Granularity', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('redshift_technical_asset_configurations', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('redshift_technical_asset_configurations', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('redshift_technical_asset_configurations', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('role_assignments_data_product', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('role_assignments_data_product', 'data_product_id', 'Data Product Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('role_assignments_data_product', 'user_id', 'User Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('role_assignments_data_product', 'role_id', 'Role Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('role_assignments_data_product', 'decision', 'Decision', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('role_assignments_data_product', 'requested_by_id', 'Requested By Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('role_assignments_data_product', 'requested_on', 'Requested On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('role_assignments_data_product', 'decided_by_id', 'Decided By Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('role_assignments_data_product', 'decided_on', 'Decided On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('role_assignments_data_product', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('role_assignments_data_product', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('role_assignments_data_product', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('role_assignments_dataset', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('role_assignments_dataset', 'dataset_id', 'Dataset Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('role_assignments_dataset', 'user_id', 'User Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('role_assignments_dataset', 'role_id', 'Role Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('role_assignments_dataset', 'decision', 'Decision', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('role_assignments_dataset', 'requested_by_id', 'Requested By Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('role_assignments_dataset', 'requested_on', 'Requested On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('role_assignments_dataset', 'decided_by_id', 'Decided By Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('role_assignments_dataset', 'decided_on', 'Decided On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('role_assignments_dataset', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('role_assignments_dataset', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('role_assignments_dataset', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12),
    ('role_assignments_dataset', 'data_product_id', 'Data Product Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 13),
    ('role_assignments_global', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('role_assignments_global', 'user_id', 'User Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('role_assignments_global', 'role_id', 'Role Id', 'string', 'UUID', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('role_assignments_global', 'decision', 'Decision', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('role_assignments_global', 'requested_by_id', 'Requested By Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('role_assignments_global', 'requested_on', 'Requested On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('role_assignments_global', 'decided_by_id', 'Decided By Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('role_assignments_global', 'decided_on', 'Decided On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('role_assignments_global', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('role_assignments_global', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('role_assignments_global', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('roles', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('roles', 'name', 'Name', 'string', 'VARCHAR', FALSE, TRUE, TRUE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('roles', 'scope', 'Scope', 'string', 'VARCHAR', FALSE, TRUE, TRUE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('roles', 'description', 'Description', 'string', 'VARCHAR', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('roles', 'permissions', 'Permissions', 'array', 'INT4[]', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('roles', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('roles', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('roles', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('roles', 'prototype', 'Prototype', 'integer', 'SMALLINT', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('rustfs_technical_asset_configurations', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('rustfs_technical_asset_configurations', 'bucket', 'Bucket', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('rustfs_technical_asset_configurations', 'suffix', 'Suffix', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('rustfs_technical_asset_configurations', 'path', 'Path', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('rustfs_technical_asset_configurations', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('rustfs_technical_asset_configurations', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('rustfs_technical_asset_configurations', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('s3_technical_asset_configurations', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('s3_technical_asset_configurations', 'bucket', 'Bucket', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('s3_technical_asset_configurations', 'suffix', 'Suffix', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('s3_technical_asset_configurations', 'path', 'Path', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('s3_technical_asset_configurations', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('s3_technical_asset_configurations', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('s3_technical_asset_configurations', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('snowflake_technical_asset_configurations', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('snowflake_technical_asset_configurations', 'database', 'Database', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('snowflake_technical_asset_configurations', 'schema', 'Schema', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('snowflake_technical_asset_configurations', 'table', 'Table', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('snowflake_technical_asset_configurations', 'bucket_identifier', 'Bucket Identifier', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('snowflake_technical_asset_configurations', 'database_path', 'Database Path', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('snowflake_technical_asset_configurations', 'table_path', 'Table Path', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('snowflake_technical_asset_configurations', 'access_granularity', 'Access Granularity', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('snowflake_technical_asset_configurations', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 9),
    ('snowflake_technical_asset_configurations', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('snowflake_technical_asset_configurations', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('tags', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('tags', 'value', 'Value', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('tags', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('tags', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('tags', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('tags_data_outputs', 'data_output_id', 'Data Output Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 1),
    ('tags_data_outputs', 'tag_id', 'Tag Id', 'string', 'UUID', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('tags_data_outputs', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('tags_data_outputs', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('tags_data_products', 'data_product_id', 'Data Product Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 2, NULL, NULL, 1),
    ('tags_data_products', 'tag_id', 'Tag Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 2),
    ('tags_data_products', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('tags_data_products', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('tags_datasets', 'dataset_id', 'Dataset Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 2, NULL, NULL, 1),
    ('tags_datasets', 'tag_id', 'Tag Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 2),
    ('tags_datasets', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('tags_datasets', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('technical_asset_access_modes', 'technical_asset_id', 'Technical Asset Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('technical_asset_access_modes', 'access_mode_id', 'Access Mode Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 2, NULL, NULL, 2),
    ('technical_asset_access_modes', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('technical_asset_access_modes', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('theme_settings', 'id', 'Id', 'integer', 'INTEGER', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 1),
    ('theme_settings', 'portal_name', 'Portal Name', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 2),
    ('users', 'email', 'Email', 'string', 'VARCHAR', FALSE, TRUE, FALSE, FALSE, NULL, NULL, NULL, NULL, 1),
    ('users', 'id', 'Id', 'string', 'UUID', TRUE, TRUE, TRUE, FALSE, NULL, 1, NULL, NULL, 2),
    ('users', 'external_id', 'External Id', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 3),
    ('users', 'first_name', 'First Name', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 4),
    ('users', 'last_name', 'Last Name', 'string', 'VARCHAR', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 5),
    ('users', 'created_on', 'Created On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 6),
    ('users', 'updated_on', 'Updated On', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 7),
    ('users', 'deleted_at', 'Deleted At', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 8),
    ('users', 'has_seen_tour', 'Has Seen Tour', 'boolean', 'BOOLEAN', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 10),
    ('users', 'can_become_admin', 'Can Become Admin', 'boolean', 'BOOLEAN', FALSE, FALSE, TRUE, FALSE, NULL, NULL, NULL, NULL, 11),
    ('users', 'admin_expiry', 'Admin Expiry', 'datetime', 'TIMESTAMP', FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, 12)
) AS p (schema_name, name, business_name, logical_type, physical_type, primary_key, "unique", required, partitioned, partition_key_position, primary_key_position, description, examples, position)
...
FROM (
    VALUES
    ('abstract_data_products', 'domain_id', 'domains', 'id'),
    ('azure_blob_technical_asset_configurations', 'id', 'data_output_configurations', 'id'),
    ('data_outputs', 'owner_id', 'data_products', 'id'),
    ('data_outputs', 'platform_id', 'platforms', 'id'),
    ('data_outputs', 'service_id', 'platform_services', 'id'),
    ('data_outputs_datasets', 'data_output_id', 'data_outputs', 'id'),
    ('data_outputs_datasets', 'dataset_id', 'datasets', 'id'),
    ('data_products', 'id', 'abstract_data_products', 'id'),
    ('data_products', 'lifecycle_id', 'data_product_lifecycles', 'id'),
    ('data_products', 'type_id', 'data_product_types', 'id'),
    ('data_products_settings_values', 'data_product_id', 'data_products', 'id'),
    ('data_products_settings_values', 'data_product_setting_id', 'data_product_settings', 'id'),
    ('data_products_settings_values', 'dataset_id', 'datasets', 'id'),
    ('data_quality_technical_assets', 'data_quality_summary_id', 'output_port_data_quality_summaries', 'id'),
    ('databricks_technical_asset_configurations', 'id', 'data_output_configurations', 'id'),
    ('dataset_curated_queries', 'output_port_id', 'datasets', 'id'),
    ('dataset_query_stats_daily', 'consumer_data_product_id', 'data_products', 'id'),
    ('dataset_query_stats_daily', 'dataset_id', 'datasets', 'id'),
    ('datasets', 'data_product_id', 'data_products', 'id'),
    ('datasets', 'lifecycle_id', 'data_product_lifecycles', 'id'),
    ('env_platform_configs', 'environment_id', 'environments', 'id'),
    ('env_platform_configs', 'platform_id', 'platforms', 'id'),
    ('env_platform_service_configs', 'environment_id', 'environments', 'id'),
    ('env_platform_service_configs', 'platform_id', 'platforms', 'id'),
    ('env_platform_service_configs', 'service_id', 'platform_services', 'id'),
    ('events', 'actor_id', 'users', 'id'),
    ('events', 'subject_type', 'event_reference_entities', 'key'),
    ('events', 'target_type', 'event_reference_entities', 'key'),
    ('explorations', 'id', 'abstract_data_products', 'id'),
    ('explorations', 'owner_id', 'users', 'id'),
    ('glue_technical_asset_configurations', 'id', 'data_output_configurations', 'id'),
    ('input_port_requests', 'access_mode_id', 'access_modes', 'id'),
    ('input_port_requests', 'decided_by_id', 'users', 'id'),
    ('input_port_requests', 'input_port_id', 'input_ports', 'id'),
    ('input_port_requests', 'requested_by_id', 'users', 'id'),
    ('input_port_requests', 'revoked_by_id', 'users', 'id'),
    ('input_ports', 'consuming_abstract_data_product_id', 'abstract_data_products', 'id'),
    ('input_ports', 'dataset_id', 'datasets', 'id'),
    ('notifications', 'event_id', 'events', 'id'),
    ('notifications', 'user_id', 'users', 'id'),
    ('osi_semantic_model_technical_asset_configurations', 'id', 'data_output_configurations', 'id'),
    ('output_port_data_quality_summaries', 'output_port_id', 'datasets', 'id'),
    ('output_port_schema_objects', 'output_port_id', 'datasets', 'id'),
    ('output_port_schema_properties', 'parent_property_id', 'output_port_schema_properties', 'id'),
    ('output_port_schema_properties', 'schema_object_id', 'output_port_schema_objects', 'id'),
    ('output_port_schema_relationships', 'source_property_id', 'output_port_schema_properties', 'id'),
    ('output_port_schema_relationships', 'target_property_id', 'output_port_schema_properties', 'id'),
    ('platform_service_configs', 'platform_id', 'platforms', 'id'),
    ('platform_service_configs', 'service_id', 'platform_services', 'id'),
    ('platform_services', 'platform_id', 'platforms', 'id'),
    ('postgresql_technical_asset_configurations', 'id', 'data_output_configurations', 'id'),
    ('redshift_technical_asset_configurations', 'id', 'data_output_configurations', 'id'),
    ('role_assignments_data_product', 'data_product_id', 'data_products', 'id'),
    ('role_assignments_data_product', 'decided_by_id', 'users', 'id'),
    ('role_assignments_data_product', 'requested_by_id', 'users', 'id'),
    ('role_assignments_data_product', 'role_id', 'roles', 'id'),
    ('role_assignments_data_product', 'user_id', 'users', 'id'),
    ('role_assignments_dataset', 'data_product_id', 'data_products', 'id'),
    ('role_assignments_dataset', 'dataset_id', 'datasets', 'id'),
    ('role_assignments_dataset', 'decided_by_id', 'users', 'id'),
    ('role_assignments_dataset', 'requested_by_id', 'users', 'id'),
    ('role_assignments_dataset', 'role_id', 'roles', 'id'),
    ('role_assignments_dataset', 'user_id', 'users', 'id'),
    ('role_assignments_global', 'decided_by_id', 'users', 'id'),
    ('role_assignments_global', 'requested_by_id', 'users', 'id'),
    ('role_assignments_global', 'role_id', 'roles', 'id'),
    ('role_assignments_global', 'user_id', 'users', 'id'),
    ('rustfs_technical_asset_configurations', 'id', 'data_output_configurations', 'id'),
    ('s3_technical_asset_configurations', 'id', 'data_output_configurations', 'id'),
    ('snowflake_technical_asset_configurations', 'id', 'data_output_configurations', 'id'),
    ('tags_data_outputs', 'data_output_id', 'data_outputs', 'id'),
    ('tags_data_outputs', 'tag_id', 'tags', 'id'),
    ('tags_data_products', 'data_product_id', 'data_products', 'id'),
    ('tags_data_products', 'tag_id', 'tags', 'id'),
    ('tags_datasets', 'dataset_id', 'datasets', 'id'),
    ('tags_datasets', 'tag_id', 'tags', 'id'),
    ('technical_asset_access_modes', 'access_mode_id', 'access_modes', 'id'),
    ('technical_asset_access_modes', 'technical_asset_id', 'data_outputs', 'id')
