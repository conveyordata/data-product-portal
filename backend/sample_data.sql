...
begin
    ...
    INSERT INTO public.input_ports (id, justification, consuming_abstract_data_product_id, dataset_id, status, requested_by_id, requested_on, approved_by_id, approved_on, denied_by_id, denied_on, created_on, updated_on, deleted_at, reasoning)
        VALUES (gen_random_uuid(),'Needed to check for GDPR compliance', data_privacy_compliance, dei_insights_dashboard_ds, 'DENIED', john_id, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL, NULL, NULL, timezone('utc'::text, CURRENT_TIMESTAMP), NULL, NULL, 'This is sensitive data');
