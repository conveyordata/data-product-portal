"""Generates sdk/plugins/*.py from the plugin classes the portal ships in
plugins/portal_plugins/.
...
PLUGINS_DIR = REPO_ROOT / "plugins" / "portal_plugins"
...
def main() -> None:
    ...
    plugin_dirs = [
        d for d in PLUGINS_DIR.iterdir() if d.is_dir() and (d / "schema.py").exists()
    ]
