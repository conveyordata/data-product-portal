"""Generates sdk/plugins/*.py from the portal's own plugin classes, in-tree
(backend/app/technical_asset_configuration/) and out-of-tree
(plugins/portal_plugins/) alike.
...
plugins the portal ships: for each plugin with its own configuration
...
TECHNICAL_ASSET_CONFIGURATION_DIR = (
    REPO_ROOT / "backend" / "app" / "technical_asset_configuration"
)
OUT_OF_TREE_PLUGINS_DIR = REPO_ROOT / "plugins" / "portal_plugins"
