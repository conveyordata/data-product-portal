...
def generate_event_handler_base():
    """Scans generated models and writes out the Abstract Base Class and an Empty Implementation for testing."""
    ...
    # Scan every Python file in the models directory (sorted for deterministic,
    # cross-platform output — directory iteration order is filesystem-dependent)
    ...
    print(f"✨ Found {len(events)} events. Generating Event Handlers...")
    ...
    empty_methods = []
    for e in events:
        empty_methods.append(f"""    async def {e["method_name"]}(self, data: {e["inner_class_name"]}) -> Any:
        pass""")
