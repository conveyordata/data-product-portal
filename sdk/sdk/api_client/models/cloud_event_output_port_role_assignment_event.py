...
if TYPE_CHECKING:
    from ..models.output_port_role_assignment_event import OutputPortRoleAssignmentEvent


T = TypeVar("T", bound="CloudEventOutputPortRoleAssignmentEvent")


@_attrs_define
class CloudEventOutputPortRoleAssignmentEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data = OutputPortRoleAssignmentEvent.from_dict(d.pop("data"))
        ...
        cloud_event_output_port_role_assignment_event.additional_properties = d
        return cloud_event_output_port_role_assignment_event
