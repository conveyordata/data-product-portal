...
T = TypeVar("T", bound="CloudEventDataProductRoleAssignmentEvent")


@_attrs_define
class CloudEventDataProductRoleAssignmentEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data = DataProductRoleAssignmentEvent.from_dict(d.pop("data"))
        ...
        cloud_event_data_product_role_assignment_event.additional_properties = d
        return cloud_event_data_product_role_assignment_event
