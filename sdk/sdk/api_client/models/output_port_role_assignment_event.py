...
T = TypeVar("T", bound="OutputPortRoleAssignmentEvent")


@_attrs_define
class OutputPortRoleAssignmentEvent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        output_port_role_assignment_event = cls(
            id=id,
            output_port_id=output_port_id,
            data_product_id=data_product_id,
            user_id=user_id,
        ...
        output_port_role_assignment_event.additional_properties = d
        return output_port_role_assignment_event
