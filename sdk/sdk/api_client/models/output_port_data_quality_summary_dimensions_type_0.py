...
T = TypeVar("T", bound="OutputPortDataQualitySummaryDimensionsType0")
...
class OutputPortDataQualitySummaryDimensionsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        output_port_data_quality_summary_dimensions_type_0 = cls()
        ...
        output_port_data_quality_summary_dimensions_type_0.additional_properties = (
            additional_properties
        )
        return output_port_data_quality_summary_dimensions_type_0
