...
T = TypeVar("T", bound="DataProductSettingsGet")


@_attrs_define
class DataProductSettingsGet:
    """
    Attributes:
        data_product_settings (list[DataProductSettingsGetItem]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_product_settings_item_data in _data_product_settings:
            data_product_settings_item = DataProductSettingsGetItem.from_dict(
                data_product_settings_item_data
            )

            data_product_settings.append(data_product_settings_item)

        data_product_settings_get = cls(
            data_product_settings=data_product_settings,
        )

        data_product_settings_get.additional_properties = d
        return data_product_settings_get
