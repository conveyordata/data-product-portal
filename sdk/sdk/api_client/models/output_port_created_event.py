...
T = TypeVar("T", bound="OutputPortCreatedEvent")


@_attrs_define
class OutputPortCreatedEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        output_port_created_event = cls(
            data_product=data_product,
            output_port=output_port,
        )

        output_port_created_event.additional_properties = d
        return output_port_created_event
