...
class InputPortEvent:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        producing_data_product_id = str(self.producing_data_product_id)
        ...
        field_dict.update(
            {
                ...
                "producing_data_product_id": producing_data_product_id,
            }
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        producing_data_product_id = UUID(d.pop("producing_data_product_id"))
