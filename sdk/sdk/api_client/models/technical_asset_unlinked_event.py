...
T = TypeVar("T", bound="TechnicalAssetUnlinkedEvent")


@_attrs_define
class TechnicalAssetUnlinkedEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        technical_asset_unlinked_event = cls(
            data_product=data_product,
            technical_asset=technical_asset,
        )

        technical_asset_unlinked_event.additional_properties = d
        return technical_asset_unlinked_event
