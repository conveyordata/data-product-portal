...
T = TypeVar("T", bound="TechnicalAssetLinkedEvent")


@_attrs_define
class TechnicalAssetLinkedEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        technical_asset_linked_event = cls(
            data_product=data_product,
            technical_asset=technical_asset,
        )

        technical_asset_linked_event.additional_properties = d
        return technical_asset_linked_event
