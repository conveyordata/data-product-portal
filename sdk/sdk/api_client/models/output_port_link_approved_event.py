...
T = TypeVar("T", bound="OutputPortLinkApprovedEvent")


@_attrs_define
class OutputPortLinkApprovedEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        output_port_link_approved_event = cls(
            abstract_data_product=abstract_data_product,
            output_port=output_port,
        )

        output_port_link_approved_event.additional_properties = d
        return output_port_link_approved_event
