...
class PlatformService:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        result_string_template = self.result_string_template

        technical_info_template = self.technical_info_template
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        result_string_template = d.pop("result_string_template")

        technical_info_template = d.pop("technical_info_template")
