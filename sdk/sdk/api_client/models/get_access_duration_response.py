...
T = TypeVar("T", bound="GetAccessDurationResponse")


@_attrs_define
class GetAccessDurationResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_access_duration_response = cls(
            access_durations=access_durations,
        )

        get_access_duration_response.additional_properties = d
        return get_access_duration_response
