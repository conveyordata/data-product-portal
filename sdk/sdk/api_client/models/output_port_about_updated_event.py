...
T = TypeVar("T", bound="OutputPortAboutUpdatedEvent")


@_attrs_define
class OutputPortAboutUpdatedEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        output_port_about_updated_event = cls(
            data_product=data_product,
            output_port=output_port,
        )

        output_port_about_updated_event.additional_properties = d
        return output_port_about_updated_event
