...
class Edge:
    ...
    Attributes:
        ...
        target (str | UUID):
        animated (bool):
        source_handle (str | Unset):  Default: 'right_s'.
        target_handle (str | Unset):  Default: 'left_t'.
    """
    ...
    target: str | UUID
    animated: bool
    source_handle: str | Unset = "right_s"
    target_handle: str | Unset = "left_t"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source(data: object) -> str | UUID:
            try:
                if not isinstance(data, str):
                    raise TypeError()
        ...
        def _parse_target(data: object) -> str | UUID:
            try:
                if not isinstance(data, str):
                    raise TypeError()
