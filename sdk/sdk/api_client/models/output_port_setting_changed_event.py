...
T = TypeVar("T", bound="OutputPortSettingChangedEvent")


@_attrs_define
class OutputPortSettingChangedEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        output_port_setting_changed_event = cls(
            data_product=data_product,
            output_port=output_port,
        )

        output_port_setting_changed_event.additional_properties = d
        return output_port_setting_changed_event
