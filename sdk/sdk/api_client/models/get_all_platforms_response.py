...
T = TypeVar("T", bound="GetAllPlatformsResponse")


@_attrs_define
class GetAllPlatformsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_platforms_response = cls(
            platforms=platforms,
        )

        get_all_platforms_response.additional_properties = d
        return get_all_platforms_response
