...
T = TypeVar("T", bound="ModifyGlobalRoleAssignment")


@_attrs_define
class ModifyGlobalRoleAssignment:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        modify_global_role_assignment = cls(
            role_id=role_id,
        )

        modify_global_role_assignment.additional_properties = d
        return modify_global_role_assignment
