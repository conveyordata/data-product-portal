...
T = TypeVar("T", bound="GlobalRoleAssignmentResponse")


@_attrs_define
class GlobalRoleAssignmentResponse:
    """
    Attributes:
        id (UUID):
        user (User):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        global_role_assignment_response = cls(
            id=id,
            user=user,
            role=role,
            decision=decision,
        ...
        global_role_assignment_response.additional_properties = d
        return global_role_assignment_response
