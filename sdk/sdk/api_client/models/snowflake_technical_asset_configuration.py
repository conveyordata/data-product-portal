...
T = TypeVar("T", bound="SnowflakeTechnicalAssetConfiguration")


@_attrs_define
class SnowflakeTechnicalAssetConfiguration:
    """
    Attributes:
        configuration_type (Literal['SnowflakeTechnicalAssetConfiguration']):
        database (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        configuration_type = cast(
            Literal["SnowflakeTechnicalAssetConfiguration"], d.pop("configuration_type")
        )
        if configuration_type != "SnowflakeTechnicalAssetConfiguration":
            raise ValueError(
                f"configuration_type must match const 'SnowflakeTechnicalAssetConfiguration', got '{configuration_type}'"
            )
        ...
        snowflake_technical_asset_configuration = cls(
            configuration_type=configuration_type,
            database=database,
            access_granularity=access_granularity,
            schema=schema,
        ...
        snowflake_technical_asset_configuration.additional_properties = d
        return snowflake_technical_asset_configuration
