...
T = TypeVar("T", bound="TechnicalAssetUpdatedEvent")


@_attrs_define
class TechnicalAssetUpdatedEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        technical_asset_updated_event = cls(
            data_product=data_product,
            technical_asset=technical_asset,
        )

        technical_asset_updated_event.additional_properties = d
        return technical_asset_updated_event
