...
T = TypeVar("T", bound="EnvironmentPlatformConfigGet")
...
class EnvironmentPlatformConfigGet:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        environment_platform_config_get = cls(
            config=config,
            id=id,
            environment=environment,
            platform=platform,
        ...
        environment_platform_config_get.additional_properties = d
        return environment_platform_config_get
