...
class UsersGet:
    ...
    Attributes:
        ...
        global_role (GlobalRoleAssignmentResponse | None):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        global_role: dict[str, Any] | None
        if isinstance(self.global_role, GlobalRoleAssignmentResponse):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_global_role(data: object) -> GlobalRoleAssignmentResponse | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                global_role_type_0 = GlobalRoleAssignmentResponse.from_dict(data)

                return global_role_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GlobalRoleAssignmentResponse | None, data)

        global_role = _parse_global_role(d.pop("global_role"))
        ...
        def _parse_admin_expiry(data: object) -> datetime.datetime | None | Unset:
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                admin_expiry_type_0 = datetime.datetime.fromisoformat(data)
        ...
        users_get.additional_properties = d
        return users_get
