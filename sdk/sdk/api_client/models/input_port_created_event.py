...
T = TypeVar("T", bound="InputPortCreatedEvent")


@_attrs_define
class InputPortCreatedEvent:
    """
    Attributes:
        id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        input_port_created_event = cls(
            id=id,
            consuming_abstract_data_product_id=consuming_abstract_data_product_id,
            consuming_abstract_data_product_type=consuming_abstract_data_product_type,
        )

        input_port_created_event.additional_properties = d
        return input_port_created_event
