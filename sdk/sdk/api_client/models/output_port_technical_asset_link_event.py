...
T = TypeVar("T", bound="OutputPortTechnicalAssetLinkEvent")


@_attrs_define
class OutputPortTechnicalAssetLinkEvent:
    """
    Attributes:
        id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        output_port_technical_asset_link_event = cls(
            id=id,
            data_product_id=data_product_id,
            output_port_id=output_port_id,
            technical_asset_id=technical_asset_id,
        ...
        output_port_technical_asset_link_event.additional_properties = d
        return output_port_technical_asset_link_event
