...
T = TypeVar("T", bound="SchemaObjectResponse")


@_attrs_define
class SchemaObjectResponse:
    """
    Attributes:
        id (UUID):
        name (str):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if physical_name is not UNSET:
            field_dict["physical_name"] = physical_name
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        physical_name = _parse_physical_name(d.pop("physical_name", UNSET))
        ...
        schema_object_response.additional_properties = d
        return schema_object_response
