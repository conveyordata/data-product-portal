...
T = TypeVar("T", bound="OwnedTechnicalAsset")


@_attrs_define
class OwnedTechnicalAsset:
    """
    Attributes:
        id (UUID):
        name (str):
    ...
    technical_mapping: TechnicalMapping
    owner_id: UUID
    configuration: OwnedTechnicalAssetConfiguration
    owner: DataProduct
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        configuration = OwnedTechnicalAssetConfiguration.from_dict(
            d.pop("configuration")
        )
        ...
        owned_technical_asset.additional_properties = d
        return owned_technical_asset
