...
T = TypeVar("T", bound="TechnicalAssetLinkApprovedEvent")


@_attrs_define
class TechnicalAssetLinkApprovedEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        technical_asset_link_approved_event = cls(
            data_product=data_product,
            technical_asset=technical_asset,
        )

        technical_asset_link_approved_event.additional_properties = d
        return technical_asset_link_approved_event
