...
T = TypeVar("T", bound="OutputPortDeletedEvent")


@_attrs_define
class OutputPortDeletedEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        output_port_deleted_event = cls(
            data_product=data_product,
            output_port=output_port,
        )

        output_port_deleted_event.additional_properties = d
        return output_port_deleted_event
