...
T = TypeVar("T", bound="DataProductRoleAssignmentResponse")


@_attrs_define
class DataProductRoleAssignmentResponse:
    """
    Attributes:
        id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data_product_role_assignment_response = cls(
            id=id,
            data_product=data_product,
            user=user,
            role=role,
        ...
        data_product_role_assignment_response.additional_properties = d
        return data_product_role_assignment_response
