...
from ...models.remove_output_port_as_input_port_request import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v2/data_products/{data_product_id}/output_ports/{output_port_id}/input_ports/remove".format(
