...
from ...models.modify_global_role_assignment import ModifyGlobalRoleAssignment
...
def _get_kwargs(
    id: UUID,
    *,
    body: ModifyGlobalRoleAssignment,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v2/authz/role_assignments/global/{id}/role".format(
