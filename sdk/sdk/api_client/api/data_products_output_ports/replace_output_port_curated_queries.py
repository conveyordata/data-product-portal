...
from ...models.output_port_curated_queries_update import OutputPortCuratedQueriesUpdate
...
def _get_kwargs(
    ...
    id: UUID,
    *,
    body: OutputPortCuratedQueriesUpdate,
) -> dict[str, Any]:
...
) -> Any | HTTPValidationError | OutputPortCuratedQueries | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | HTTPValidationError | OutputPortCuratedQueries]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | HTTPValidationError | OutputPortCuratedQueries
    """
