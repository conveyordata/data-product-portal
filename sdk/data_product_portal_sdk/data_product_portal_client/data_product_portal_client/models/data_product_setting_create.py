...
T = TypeVar("T", bound="DataProductSettingCreate")


@_attrs_define
class DataProductSettingCreate:
    """
    Attributes:
        category (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data_product_setting_create = cls(
            category=category,
            type_=type_,
            tooltip=tooltip,
            external_id=external_id,
        ...
        data_product_setting_create.additional_properties = d
        return data_product_setting_create
