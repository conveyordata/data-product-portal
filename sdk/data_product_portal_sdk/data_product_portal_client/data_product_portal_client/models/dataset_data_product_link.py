...
T = TypeVar("T", bound="DatasetDataProductLink")


@_attrs_define
class DatasetDataProductLink:
    """
    Attributes:
        dataset_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        dataset_data_product_link.additional_properties = d
        return dataset_data_product_link
