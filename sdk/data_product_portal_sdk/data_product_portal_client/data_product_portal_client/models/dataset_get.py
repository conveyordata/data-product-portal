...
if TYPE_CHECKING:
    ...
    from ..models.data_product_link import DataProductLink
    from ..models.data_product_setting_value import DataProductSettingValue
    from ..models.tag import Tag
    from ..models.user import User


T = TypeVar("T", bound="DatasetGet")
...
class DatasetGet:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        data_product_links = []
        for data_product_links_item_data in self.data_product_links:
            data_product_links_item = data_product_links_item_data.to_dict()
            data_product_links.append(data_product_links_item)
        ...
        field_dict.update(
            {
                ...
                "owners": owners,
                "data_product_links": data_product_links,
                "lifecycle": lifecycle,
                "status": status,
                "tags": tags,
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data_product_links = []
        _data_product_links = d.pop("data_product_links")
        for data_product_links_item_data in _data_product_links:
            data_product_links_item = DataProductLink.from_dict(
                data_product_links_item_data
            )
        ...
        dataset_get.additional_properties = d
        return dataset_get
