...
T = TypeVar("T", bound="DataOutputDatasetAssociation")


@_attrs_define
class DataOutputDatasetAssociation:
    """
    Attributes:
        dataset_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data_output_dataset_association = cls(
            dataset_id=dataset_id,
            status=status,
            id=id,
            data_output_id=data_output_id,
        ...
        data_output_dataset_association.additional_properties = d
        return data_output_dataset_association
