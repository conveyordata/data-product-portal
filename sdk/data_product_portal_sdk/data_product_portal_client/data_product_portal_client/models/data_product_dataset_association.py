...
from ..models.data_product_dataset_link_status import DataProductDatasetLinkStatus
...
T = TypeVar("T", bound="DataProductDatasetAssociation")


@_attrs_define
class DataProductDatasetAssociation:
    """
    Attributes:
        dataset_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        status = DataProductDatasetLinkStatus(d.pop("status"))
        ...
        data_product = BaseDataProductGet.from_dict(d.pop("data_product"))
        ...
        data_product_dataset_association = cls(
            dataset_id=dataset_id,
            status=status,
            id=id,
            data_product_id=data_product_id,
        ...
        data_product_dataset_association.additional_properties = d
        return data_product_dataset_association
