...
T = TypeVar("T", bound="DataOutputLink")


@_attrs_define
class DataOutputLink:
    """
    Attributes:
        dataset_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data_output = DataOutputGet.from_dict(d.pop("data_output"))
        ...
        data_output_link.additional_properties = d
        return data_output_link
