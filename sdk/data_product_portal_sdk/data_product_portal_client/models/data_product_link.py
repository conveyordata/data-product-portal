...
if TYPE_CHECKING:
    from ..models.data_products_get import DataProductsGet
    from ..models.dataset import Dataset
    from ..models.user import User


T = TypeVar("T", bound="DataProductLink")
...
class DataProductLink:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data_product = DataProductsGet.from_dict(d.pop("data_product"))
        ...
        data_product_link.additional_properties = d
        return data_product_link
