...
T = TypeVar("T", bound="DataProductSetting")


@_attrs_define
class DataProductSetting:
    """
    Attributes:
        category (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        data_product_setting.additional_properties = d
        return data_product_setting
