...
export const versionApiSlice = baseApiSlice
    .enhanceEndpoints({ addTagTypes: versionTags })
    .injectEndpoints({
        endpoints: (builder) => ({
            getVersion: builder.query<VersionResponse, void>({
                ...
                providesTags: (version) => version ? [
                   { type: TagTypes.Version as const, id: version.version }
                ] : [],
            }),
        }),
