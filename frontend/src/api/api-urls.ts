export enum ApiUrl {
    ...
    RoleAssignmentsDataProductRequest = '/api/v2/authz/role_assignments/data_product/request',
    ...
    RoleAssignmentsDatasetRequest = '/api/v2/authz/role_assignments/output_port/request',
    ...
    RoleAssignmentsBecomeAdmin = '/api/role_assignments/global/become_admin',
    RoleAssignmentsRevokeAdmin = '/api/role_assignments/global/revoke_admin',
