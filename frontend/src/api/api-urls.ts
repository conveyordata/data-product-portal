export enum ApiUrl {
    ...
    RoleAssignmentsDataProductDelete = '/api/role_assignments/data_product/:assignmentId',
    RoleAssignmentsDataProductUpdate = '/api/role_assignments/data_product/:assignmentId/role',
