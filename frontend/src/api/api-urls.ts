export enum ApiUrl {
    ...
    DatasetMembershipAdd = '/api/dataset_memberships/create',
    DatasetMembershipUpdate = '/api/dataset_memberships/:membershipId/role',
    DatasetMembershipRequest = '/api/dataset_memberships/request',
    DatasetMembershipApprove = '/api/dataset_memberships/:membershipId/approve',
    DatasetMembershipDeny = '/api/dataset_memberships/:membershipId/deny',
    DatasetMembershipRemove = '/api/dataset_memberships/:membershipId/remove',
    DatasetMembershipPendingActions = '/api/dataset_memberships/actions',
    Users = '/api/users',
