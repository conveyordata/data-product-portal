...
import { Button, Empty, Flex, Input, Table, Typography } from 'antd';
...
import { getMyAccessTableColumns } from '@/pages/my-access/my-access-table-columns.tsx';
import {
...
export function MyAccessSection() {
    ...
    return (
        <Flex vertical gap="small">
            <Typography.Title level={3}>{t('My Access')}</Typography.Title>
