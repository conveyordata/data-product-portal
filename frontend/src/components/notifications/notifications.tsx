        ...
        (
            ...
            switch (userNotification.notification_type) {
                case NotificationTypes.DataProductDatasetNotification:
                    link = createDataProductIdPath(userNotification.data_product_dataset.data_product_id);
                    switch (userNotification.notification_origin) {
                        case DecisionStatus.Approved:
                            description =
                                currentUser?.id === userNotification.data_product_dataset.requested_by.id ? (
                                    <Typography.Text>
                                        {t('{{name}} approved your request made on behalf of the', {
                                            name: userNotification.data_product_dataset.approved_by?.first_name,
                                        })}{' '}
                                ...
                                currentUser?.id === userNotification.data_product_dataset.requested_by.id ? (
                                    <Typography.Text>
                                        {t('{{name}} denied your request made on behalf of the', {
                                            name: userNotification.data_product_dataset.denied_by?.first_name,
                                        })}{' '}
                                        <Link onClick={(e) => e.stopPropagation()} to={link}>
                                            {userNotification.data_product_dataset.data_product.name}
                                        </Link>{' '}
                ...
                case NotificationTypes.DataOutputDatasetNotification:
                    ...
                    switch (userNotification.notification_origin) {
                        case DecisionStatus.Approved:
                            description =
                                currentUser?.id === userNotification.data_output_dataset.requested_by.id ? (
                                    <Typography.Text>
                                        {t('{{name}} approved your request made on behalf of the', {
                                            name: userNotification.data_output_dataset.approved_by?.first_name,
                                        })}{' '}
                                        <Link onClick={(e) => e.stopPropagation()} to={link}>
                        ...
                        case DecisionStatus.Denied:
                            description =
                                currentUser?.id === userNotification.data_output_dataset.requested_by.id ? (
                                    <Typography.Text>
                                        {t('{{name}} denied your request made on behalf of the', {
                                            name: userNotification.data_output_dataset.denied_by?.first_name,
                                        })}{' '}
                                        <Link onClick={(e) => e.stopPropagation()} to={link}>
                                            {userNotification.data_output_dataset.data_output.name}
                                        </Link>{' '}
                ...
                case NotificationTypes.DataProductMembershipNotification:
                    link = createDataProductIdPath(userNotification.data_product_membership.data_product_id);
                    switch (userNotification.notification_origin) {
                        case DecisionStatus.Approved:
                            description =
                                currentUser?.id === userNotification.data_product_membership.user.id ? (
                                    <Typography.Text>
                                        {t('{{name}} approved your request to join the', {
                                            name: userNotification.data_product_membership.approved_by?.first_name,
                                        })}{' '}
                                        <Link onClick={(e) => e.stopPropagation()} to={link}>
                                    ...
                                    <Typography.Text>
                                        {t('{{name}} has been granted the role of {{role}} in the team of the', {
                                            name: userNotification.data_product_membership.user?.first_name,
                                            role: userNotification.data_product_membership.role,
                                        })}{' '}
                                        <Link onClick={(e) => e.stopPropagation()} to={link}>
                                            {userNotification.data_product_membership.data_product.name}
                                        </Link>{' '}
                                ...
                                currentUser?.id === userNotification.data_product_membership.user.id ? (
                                    <Typography.Text>
                                        {t('{{name}} denied your request to join the', {
                                            name: userNotification.data_product_membership.denied_by?.first_name,
                                        })}{' '}
                                        <Link onClick={(e) => e.stopPropagation()} to={link}>
                                            {userNotification.data_product_membership.data_product.name}
                                        </Link>{' '}
