...
*   **Async races**: Disable the control during an in-flight request instead of guarding against stale responses; use the RTK Query hook's `isLoading` instead of tracking it yourself.
