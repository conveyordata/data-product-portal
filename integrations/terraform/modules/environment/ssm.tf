resource "aws_ssm_parameter" "datalake_bucket" {
  name  = "/platform/public/${var.env}/datalake/bucket"
  type  = "String"
  value = aws_s3_bucket.datalake.id
}

resource "aws_ssm_parameter" "datalake_kms_key_arn" {
  name  = "/platform/public/${var.env}/datalake/kms_key"
  type  = "String"
  value = aws_kms_key.datalake.arn
}

resource "aws_ssm_parameter" "logs_bucket" {
  name  = "/platform/public/${var.env}/logs/bucket"
  type  = "String"
...
resource "aws_ssm_parameter" "ingress_bucket" {
  ...
  name  = "/platform/public/${var.env}/ingress/bucket"
  type  = "String"
...
resource "aws_ssm_parameter" "ingress_kms_key_arn" {
  ...
  name  = "/platform/public/${var.env}/ingress/kms_key"
  type  = "String"
...
resource "aws_ssm_parameter" "egress_bucket" {
  ...
  name  = "/platform/public/${var.env}/egress/bucket"
  type  = "String"
...
resource "aws_ssm_parameter" "egress_kms_key_arn" {
  ...
  name  = "/platform/public/${var.env}/egress/kms_key"
  type  = "String"
