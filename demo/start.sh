...
echo ""
echo "📚 Next steps:"
echo "  1. The 'CoMix Survey Data' demo product is auto-created on startup"
echo "  2. Check demo/products/comix-survey-data/ for the scaffolded project"
echo "  3. View docs at http://localhost:8888/docs/comix-survey-data/"
echo "  4. Open the project in Coder or RStudio to start developing"
echo "  5. Create additional data products via the portal UI"
echo ""
echo "📖 For more information, see demo/README.md"
echo ""
echo "🛑 To stop: docker compose down"
echo "📋 View logs: docker compose logs -f provisioner"
