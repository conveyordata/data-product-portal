...
INSERT INTO inventory_snapshot.stock_levels (
    sku, qty_oh, loc_id, is_retired, captured_at
) VALUES
...
CREATE TABLE sales_transaction_ledger.orders (
    ...
    -- Status trap: 'DELIVERED', 'SHIPPED', 'CANCELLED', NULL (for processing)
    status VARCHAR(20),
...
-- Processing
(1004, 3, 4500, 4600, NULL, '2026-02-08 14:00:00', '2026-02-08 14:00:00', NULL),
(
    1005,
    4,
    12500,
...
INSERT INTO sales_transaction_ledger.recurring_revenue (
    customer_id, mrr, arr, status, started_at, ended_at
) VALUES
...
INSERT INTO customer_demographic_master.customers (
    id, email, full_name, acquired_by, status, signup_date
) VALUES
